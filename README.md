...
3.  **Point Separation**: Points on the same row must be separated by one or more spaces. Sometimes other whitespaces are accepted as delimiters, just because of how atoi works, but users are advised to use space.
